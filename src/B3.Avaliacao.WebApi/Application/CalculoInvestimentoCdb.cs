...
{
    public class CalculoInvestimentoCdb : ICalculoInvestimentoCdb
    {
        ...
        public void ConfiguraValores(int meses, decimal valorMonetario)
        {
            investimento = new Investimento(valorMonetario, meses);
        }
